    ...
    <x-modal>
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            <button wire:click="closeModal()"
                class="focus:outline-none absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
            ...
            <div class="px-6 py-6">
                <form class="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <textarea wire:model="description" name="description" id="description" placeholder="Description"
